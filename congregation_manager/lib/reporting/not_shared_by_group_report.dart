...
pw.Document generateNotSharedInMinistryByGroupReport({
  ...
  for (final r in reports) {
    ...
    final groupName = (person?.fieldServiceGroupId != null
  ...
  pdf.addPage(pw.MultiPage(
    ...
    header: (context) => pw.Column(
      children: [
        ...
        pw.Text(subtitle,
            style: pw.TextStyle(
                fontSize: 12, color: PdfStyles.footerColor)),
        pw.Text('Grouped by Field Service Group',
            style: pw.TextStyle(
                fontSize: 10,
    ...
    footer: (context) => pw.Row(
      ...
      children: [
        pw.Text(generatedAt,
            style: pw.TextStyle(
                fontSize: 8, color: PdfStyles.footerColor)),
        pw.Text(
          ...
          decoration: pw.BoxDecoration(
            border: pw.Border(
                bottom: pw.BorderSide(
                    color: PdfStyles.headerColor, width: 2)),
          ),
          child: pw.Row(
            mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
            children: [
              ...
              pw.Text('(${grouped[groupName]!.length})',
                  style: pw.TextStyle(
          ...
          children: [
            ...
            pw.TableHelper.fromTextArray(
              ...
              data: [
                ...
                for (final key in sortedKeys.toList()
                  ..sort((a, b) =>
